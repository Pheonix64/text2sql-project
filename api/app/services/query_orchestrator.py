...
#### PÉRIMÈTRE ET RÈGLES (STRICT) :
 ...
 - Cible BCEAO : 1%–3%. L'intervalle cible définition par la BCEAO.
 ...
 - Toute prévision doit être justifiée par une valeur SHAP et avec la date de la valeur de l'inflation correspondante.
...
- [ ] **Trouver des termes et expressions pour "SHAP" pour permettre à un public qui ne connais pas l'IA.
...
- Message principal pour le Comité de Politique Monétaire en ce qui concerne l'inflation.
